...
// Fetch contact form submissions data
$contactFormResult = $conn->query("SELECT * FROM contact_form");
$contactFormSubmissions = [];
while ($row = $contactFormResult->fetch_assoc()) {
    $contactFormSubmissions[] = $row;
}
