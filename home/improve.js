  ...
  function countdown() {
    ...
    var timer = setInterval(function(){
        ...
        if (seconds === 0) {
            // Display score and show the modal
            document.getElementById("finalScore").innerText = points;
            document.getElementById("scoreModal").style.display = "block";  // Show modal
...
// Function to send score to PHP script
